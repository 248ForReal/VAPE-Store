  ...
  <div class="product">
    ...
    <div class="block-price-rating clearfix">
      ...
      <div class="block-price clearfix">
        ...
        <span class="price-new-dollar">Rp <?= number_format($row['harga'], 0, ',', '.') ?></span>
        </div>
      </div>
    </div>
    <!--PRODUCT DESCRIPTION-->
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="d-flex flex-row align-items-center">
              <div style="width: 150px;">
                <h5 class="fw-normal mb-0"><?= $row['p_quantity'] ?> x Rp.<?=number_format($row['harga_satuan'], 0, ',', '.') ?></h5>
              </div>
              <div style="width: 128px;">
                <h5 class="mb-0">Rp.<?= number_format($row['harga_total'],0,',','.') ?></h5>
              </div>
            ...
            if ($resultStok->num_rows > 0) {
                ...
                if ($jumlahPesan <= $stokBarang) {
                    ...
                    if ($resultInsert) {
                        ...
                        $sqlDelete = "DELETE FROM keranjang WHERE pemesan = '$a'";
                        $resultDelete = mysqli_query($connection, $sqlDelete);

                        echo "<script>alert('Berhasil Checkout');window.open('https://api.whatsapp.com/send/?phone=62$company_no&text=Nomor%20Orderan%20:%20$id_baru%0ANama%20Penerima%20:%20$penerima%0AAlamat%20:%20$address%0AOrder%20:%20$itemsString%0AHarga%20:%20Rp%20" . number_format($total, 0, ',', '.') . "%20', '_blank');window.location.href = '../page/product.php';</script>";
    ...
    <div class="card mb-3">
      <div class="card-body">
        <div class="d-flex justify-content-between">
          ...
          <div class="d-flex flex-row align-items-center">
            <div style="width: 150px;">
            <h5 class="mb-0">Rp.<?= number_format($row['total_harga'], 0, ',', '.') ?></h5>
            </div>
