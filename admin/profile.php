                        ...
                        <div class="card shadow mb-4 w-100">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="w-25">
                                            <div>
                                            <img src="../image/logo/<?php echo $company_logo;?>"class="tumbnail w-100 rounded-circle">
                                            </div>
                                            <div class="mt-3">
                                        ...
                                        <td class="align-self-center">
                                            ...
                                            <div class="input-group flex-nowrap mb-3">
                                                <input type="text" name="companyDesc" class="form-control" value="<?php echo $company_add?>" aria-describedby="addon-wrapping">
                                            </div>
                                            <div style="font-weight: bold;">Nomor Telepon</div>
                                            <div class="input-group flex-nowrap mb-3">
                                                <input type="text" name="companyCall" class="form-control" value="<?php echo $company_no;?>" aria-describedby="addon-wrapping">
                                            </div>
...
$edit_logo = mysqli_query($connection, 
"UPDATE company SET logp = '$edit_foto'");
...
$edit_profile = mysqli_query($connection,"UPDATE company SET nama = '$name', alamat = '$desc', nomor_telp = '$call', email = '$email'");
echo '<script> location.replace("profile.php"); </script>';
}
?>
